...
namespace BlazorApp3.Models
{
    ...
    public partial class CRUDOPERATIONContextProcedures : ICRUDOPERATIONContextProcedures
    {
        ...
        public virtual async Task<int> EmployeeUpdateAsync(int? ID, string Name, DateTime? DOB, string Location, string Designation, string Email_Address, string Gender, bool? Deleted, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
